    ...
    $(document).ready(function () {
      oTable = $('#table').DataTable({
          ...
          "dom": '<"dataTables_wrapper form-inline dt-bootstrap no-footer" <"row" <"toolbar col-sm-2"> <"col-sm-7"l> <"col-sm-3"f> > rt'+
              '<"row" <"col-sm-5"i><"col-sm-7"p>><"clear">',
              "initComplete":   function(){
                  $("div.toolbar").html('<a href="{{ route('appledays.export.file',['type'=>'xlsx']) }}" class="btn btn-primary btn-sm" style="width: calc(50% - 5px);"><i class="fa fa-file-excel-o"></i> Excel</a> <a style="width: calc(50% - 5px);" href="{{ route('appledays.export.file',['type'=>'csv']) }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-download"></i> CSV</a>');
              },
