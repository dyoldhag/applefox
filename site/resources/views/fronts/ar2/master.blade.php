...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="{{$page_class or ''}}">
      ...
      <div class="screenfoxhorizontal-popup"><div class="screenfox-popupcontent">
        <div><img src="{{ asset('/images/ar/screenfoxhorizontal.png') }}" alt="screenfoxhorizontal"></div>
        <h3>Tilt your phone for the best experience.</h3>
      </div></div>
